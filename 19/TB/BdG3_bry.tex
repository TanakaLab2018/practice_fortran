...
\part{BdGモデルハミルトニアンについてtest}
	...
	今度は、$\hat{\Delta}(r)=\Delta_0\frac{1}{k_f} \left( \partial x+i\partial y \right)\hat{\sigma}_1$のときを考える。求める式は、
		...
		以下
		\begin{align}
			\eta=\Delta_0\frac{1}{k_f} \\
			\eta^{'}=\Delta_0^\ast\frac{1}{k_f}
		\end{align}
		とする
		...
		\begin{align}
			...
			e^{-ik_yy} \left[ \Psi_\uparrow^\dagger \left( -\frac{\hbar^2}{2m}\nabla^2-\mu_F \right) +\Psi_\downarrow^\dagger \eta \left( \partial x+i\partial y \right) \right] \Psi_\uparrow e^{ik'_yy} \nonumber\\
			+e^{-ik_yy} \left[ \Psi_\downarrow^\dagger \left( -\frac{\hbar^2}{2m}\nabla^2-\mu_F \right) +\Psi_\uparrow^\dagger \eta \left( \partial x+i\partial y \right) \right] \Psi_\downarrow e^{ik'_yy} \nonumber\\
			+ e^{-ik_yy} \left[ \Psi_\downarrow -\eta^{'} \left( \partial x-i\partial y \right) +\Psi_\uparrow \left( \frac{\hbar^2}{2m}\nabla^2+\mu_F \right) \right] \Psi_\uparrow^\dagger e^{ik'_yy} \nonumber\\
			+e^{-ik_yy} \left[ \Psi_\uparrow -\eta^{'} \left( \partial x-i\partial y \right)+\Psi_\downarrow \left( \frac{\hbar^2}{2m}\nabla^2+\mu_F \right) \right] \Psi_\downarrow^\dagger e^{ik'_yy}
		\end{align}
		...
		\begin{align}
			...
			+\Psi_\downarrow^\dagger \eta\left( \partial x-k_y \right) \Psi_\uparrow \right. \nonumber \\ \left.+
			...
			+\Psi_\uparrow^\dagger \eta \left( \partial x-k_y \right) \Psi_\downarrow \cdots
			\right]
			\label{hamil2}
		\end{align}
		...
		\begin{align}
			...
			^T
			\begin{bmatrix}
				\varepsilon_{k_y} & 0 & 0 & -k_y\eta & -\varLambda & 0 & 0 & \zeta & 0 & 0 & 0 & 0 \\
				0 & \varepsilon_{k_y} & -k_y\eta & 0 & 0 & -\varLambda & \zeta & 0 & 0 & 0 & 0 & 0 \\
				0 & -k_y\eta^{'} & -\varepsilon_{k_y} & 0 & 0 & -\zeta^{'} & \varLambda & 0 & 0 & 0 & 0 & 0 \\
				-k_y\eta^{'} & 0 & 0 & -\varepsilon_{k_y} & -\zeta^{'} & 0 & 0 & \varLambda & 0 & 0 & 0 & 0 \\
				-\varLambda & 0 & 0 & -\zeta & \varepsilon_{k_y} & 0 & 0 & -k_y\eta & -\varLambda & 0 & 0 & \zeta \\
				0 & -\varLambda & -\zeta & 0 & 0 & \varepsilon_{k_y} & -k_y\eta & 0 & 0 & -\varLambda & \zeta & 0 \\
				0 & \zeta^{'} & \varLambda & 0 & 0 & -k_y\eta^{'} & -\varepsilon_{k_y} & 0 & 0 & -\zeta^{'} & \varLambda & 0 \\
				\zeta^{'} & 0 & 0 & \varLambda & -k_y\eta^{'} & 0 & 0 & -\varepsilon_{k_y} & -\zeta^{'} & 0 & 0 & \varLambda \\
				0 & 0 & 0 & 0 & -\varLambda & 0 & 0 & -\zeta & \varepsilon_{k_y} & 0 & 0 & -k_y\eta \\
				0 & 0 & 0 & 0 & 0 & -\varLambda & -\zeta & 0 & 0 & \varepsilon_{k_y} & -k_y\eta & 0 \\
				0 & 0 & 0 & 0 & 0 & \zeta^{'} & \varLambda & 0 & 0 & -k_y\eta^{'} & -\varepsilon_{k_y} & 0 \\
				0 & 0 & 0 & 0 & \zeta^{'} & 0 & 0 & \varLambda & -k_y\eta^{'} & 0 & 0 & -\varepsilon_{k_y}
			\end{bmatrix}
			\begin{bmatrix}
				\Psi_{1\uparrow} \\
				\Psi_{1\downarrow} \\
